...
Matrix4x4& Matrix4x4::EuclideanInverse() {
...
std::ostream& operator<<(std::ostream& os, const Matrix4x4& m) {
	os << "[" << m.m00_ << ", " << m.m01_ << ", " << m.m02_ << ", " << m.m03_ << std::endl
		<< " " << m.m10_ << ", " << m.m11_ << ", " << m.m12_ << ", " << m.m13_ << std::endl
		<< " " << m.m20_ << ", " << m.m21_ << ", " << m.m22_ << ", " << m.m23_ << std::endl
